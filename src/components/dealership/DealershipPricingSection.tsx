/**
 * DealershipPricingSection Component - Mia.inc Minimal Style
 *
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-xl md:text-2xl text-neutral-600 max-w-3xl mx-auto">
            Custom AI system built specifically for your dealership.
          </p>
        </div>

        <div className="max-w-3xl mx-auto">
          <div className="bg-white border-2 border-primary rounded-lg p-12 text-center">
            <h3 className="text-3xl font-bold text-secondary mb-4">Dealership AI System</h3>
            <p className="text-neutral-600 mb-8 leading-relaxed">
              Every dealership is different. We build a custom solution based on your inventory size, systems, and goals.
            </p>
            ...
            <p className="text-neutral-500 mt-6 text-sm">
              Typical ROI: $25K-$50K+ additional revenue per month
            </p>
          </div>
        </div>
      </div>
